...
// provider interface is needed for the exception mapper to work correctly
@Provider
// the connectFourExceptionMapper maps a connect four exception to a response
public class ConnectFourExceptionMapper implements ExceptionMapper<ConnectFourException> {
    ...
    public Response toResponse(ConnectFourException connectFourException) {
        ...
        // response status 422 means that the request entity was correct
        // but the data couldn't be processed
